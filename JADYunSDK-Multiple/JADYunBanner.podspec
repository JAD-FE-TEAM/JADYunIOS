Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://storage.jd.com/ios-sdk-libs/multiple_packages/'+s.version.to_s+'/JADYunBanner.framework.zip'}
  
  s.ios.deployment_target    = '9.0'
  s.swift_version = '4.0'
  s.ios.vendored_framework   = 'JADYunBanner.framework'
